from SupplyChain import SupplyChain #Import SupplyChain class
import random
import numpy as np
...
class Genetic_Algorithm:
    ...
    def rouletteWheelSelection(self):'''Step 4: Parents selection based on roulette wheel selection'''
        pass
