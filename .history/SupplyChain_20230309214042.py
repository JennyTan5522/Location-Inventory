...
class SupplyChain:
    ...
    def dcArrivalRate(self,X):
        ...
        DC_ARRIVAL_RATE_1=[]
        DC_ARRIVAL_RATE_2=[]
        #Find the summation of the retailer
        RETAILER_ARRIVAL_RATE_1=np.reshape(RETAILER_ARRIVAL_RATE_1,(1,self.NO_OF_RETAILER))
        #No of retailer*X
        DC_ARRIVAL_RATE_1=np.matmul(RETAILER_ARRIVAL_RATE_1,np.array(X))
        DC_ARRIVAL_RATE_1
