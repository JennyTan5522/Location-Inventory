...
class SupplyChain:
    ...
    def calcProbState0(self,s,Q:list):
    ...
    def calcInventoryLevelCost(self,s,Q:list):#TODO
    ...
    def calcTerm2(self,Y:list,s,Q:list):
    ...
    def calcTotalCost(self,X:list,Y:list,s,Q:list):
