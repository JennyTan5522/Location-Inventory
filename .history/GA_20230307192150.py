...
class Genetic_Algorithm():
    ...
    def new_generation(self):
        ...
        #=======================================================================================================
        def mutation(chromosome):#Take generated childs from the crossover step
            
            def inversion_mutation():'''Step 6: Mutation used to maintain the genetic diversity of the chromosomes'''
            ...
            for _ in range(len(chromosome)):
                if random.random()<self.GEN_MUT_RATE:
                    chromosome_mutation=inversion_mutation(chromosome)
