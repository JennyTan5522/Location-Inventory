...
class SupplyChain:
    ...
    def __init__(self,PROBLEM_SIZE,SITUATION_TYPE):
        ...
        self.RETAILER_ARRIVAL_RATE_1=[20,25,30,35,40]
        self.RETAILER_ARRIVAL_RATE_2=[25,30,35,38,45]
    ...
    def calcShortageRate2(self,s):
        ...
        shortageRate2List=[]
        for j in range(self.NO_OF_DC):
            shortageRate2List.append(self.DC_ARRIVAL_RATE_2[j]*pow((1+self.LEAD_TIME[j]/self.DC_ARRIVAL_RATE_1[j]),s[j]))
