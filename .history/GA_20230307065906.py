...
class Genetic_Algorithm():
    ...
    def crossOver(self):
        ...
        n_parent1=random.randint(0,round(len(population)*0.8))
        n_parent2=random.randint(0,round(len(population)*0.8))
        #Ensure that both parent 
        n_parent2=random.randint(0,round(len(population)*0.8)) if n_parent1==n_parent2 else n_parent2
        
        #n_parent2=
        #n_parents=round(len(population)*self.CROSS_RATE)
