...
class Genetic_Algorithm():
    ...
    def crossOver(self):def rouletteWheelSelection(self,pop_parents):
        ...
        n_parent1=self.rouletteWheelSelection(pop_parent1)
        n_parent2=self.rouletteWheelSelection(pop_parent2)
