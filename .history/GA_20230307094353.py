...
class Genetic_Algorithm():
    ...
    def initialPopulation(self,sc):
        ...
        print(self.X)
        print(self.Y)  
        self.n_parents=round(self.POP_SIZE*self.CROSS_RATE)
        self.n_parents=self.n_parents if self.n_parents%2==0 else self.n_parents-1 #Ensure the parents used to crossover is even number
    #=======================================================================================================
    ...
    #=======================================================================================================
    def crossOver(self,self.parents):
