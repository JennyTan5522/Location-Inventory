...
class Genetic_Algorithm():
    #random.seed(42)
    def __init__(self,MAX_GENERATION,POP_SIZE,MAX_SAME_ANSWER_PRODUCED,CROSS_RATE,GEN_MUT_RATE,SUPPLY_CHAIN):
        ...
        self.INDIVIDUAL_LENGTH=SUPPLY_CHAIN.NO_OF_RETAILER
