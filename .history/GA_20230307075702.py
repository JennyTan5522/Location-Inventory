...
class Genetic_Algorithm():
    ...
    def __init__(self,MAX_GENERATION,POP_SIZE,MAX_SAME_ANSWER_PRODUCED,CROSS_RATE,GEN_MUT_RATE):
        ...
        population=[self.generateChromosome() for _ in range(self.POP_SIZE)]
        X=[self.generateX(population[idx]) for idx in range(len(population))]
        Y=[self.generateY(X[idx]) for idx in range(len(population))]        
        #=======================================================================================================
        ...
        def crossOver(self):
            ...
            chromosome_selection=[rouletteWheelSelection() for _ in range(round(len(population)*0.1))]
