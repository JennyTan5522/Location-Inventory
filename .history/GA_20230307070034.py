...
class Genetic_Algorithm():
    ...
    def rouletteWheelSelection(self,n_parents):
    ...
    def crossOver(self):
        ...
        prob_parent1=random.randint(0,round(len(population)*0.8))
        prob_parent1=2=random.randint(0,round(len(population)*0.8))
