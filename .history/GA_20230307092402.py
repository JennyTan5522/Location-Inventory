...
class Genetic_Algorithm():
    ...
    def initialPopulation(self,sc):
        ...
        self.population=[generateChromosome(self) for _ in range(self.POP_SIZE)]
        self.X=[generateX(self,self.population[idx]) for idx in range(len(self.population))]
        self.Y=[generateY(self,self.X[idx]) for idx in range(len(self.population))]        
    #=======================================================================================================
