...
class Genetic_Algorithm():
    ...
    def crossOver(self):
        ...
        print(self.n_parents)
        #3. Cross over parents to generate new offsprings
        childs=[]
        #Select 2 parents and pass to crossOverParent
        for i in range(0,len(self.n_parents),2):
            pass
        
        def crossOverParent(parent1,parent2):
            #Check whether after cross over process exists any repeated child
            def process_gen_repeated(copy_child1,copy_child2):
                count1=0
                #Check the copy_child1's repeated child
                ...
                #Check the copy_child2's repeated child
                count1=0
