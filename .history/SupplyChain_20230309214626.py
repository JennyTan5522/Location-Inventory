...
class SupplyChain:
    ...
    def dcArrivalRate(self,X):
        ...
        dcArrivalRate1=np.matmul(self.RETAILER_ARRIVAL_RATE_1,np.array(X))
        retailerArrivalRate2=np.reshape(self.RETAILER_ARRIVAL_RATE_2,(1,self.NO_OF_RETAILER))
        dcArrivalRate2=np.matmul(self.RETAILER_ARRIVAL_RATE_2,np.array(X))
        DC_ARRIVAL_RATE_1=[arrival for _,arrival in enumerate(DC_ARRIVAL_RATE)]
        DC_ARRIVAL_RATE_2=[arrival for _,arrival in enumerate(DC_ARRIVAL_RATE)]
