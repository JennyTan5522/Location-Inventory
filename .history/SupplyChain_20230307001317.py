...
class SupplyChain:
    ...
    def __init__(self,PROBLEM_SIZE,SITUATION_TYPE):
        ...
        self.DC_ARRIVAL_RATE=[random.randint(cost_list['DC_ARRIVAL_RATE'][0],cost_list['ARRIVAL_RATE'][1]) for _ in range(self.NO_OF_DC)]
    ...
    def calcTerm5(self,Y:list):
        ...
        for j in range(self.NO_OF_DC):
            for r in range(self.CUSTOMER_CLASS): 
