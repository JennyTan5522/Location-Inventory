...
class Genetic_Algorithm:
    ...
    def initialPopulation(self):
        ...
        #TODO inside need self, GOT X AND Y 
        #DO I NEED TO ASSIGN INSIDE HERE OR NO NEED
        #X AND Y ONLY do in evaluation there (WHen want calculate total cost)
    ...
    def evaluateOffsprings(self):
        ...
        #Best chromosome, everytime will check whether it will 
        pass
